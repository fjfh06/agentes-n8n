...
El objetivo es dominar la orquestación visual de workflows complejos, entender cómo funcionan los sistemas RAG, y aprender a integrar múltiples servicios de forma coherente y profesional.
...
- **Arquitectura (1 min)**: Explicación rápida de componentes (n8n, Ollama, Qdrant, PostgreSQL)
- **Demo en vivo (2-3 min)**:
  - Subir documento → mostrar en Qdrant → hacer 2-3 preguntas → mostrar tabla PostgreSQL
...
- **Título**: Entrega HITO 3 - [Nombre proyecto] - Sistema RAG
...
| 4   | 🔍 Funcionalidad específica | 3.0  | RAG no funciona correctamente                 | Funciona con limitaciones evidentes    | Implementación completa y funcional       |
